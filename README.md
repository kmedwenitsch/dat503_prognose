...
Dieses Projekt umfasst drei Prognosemodelle für den österreichischen Häuserpreisindex (HPI).
...
In dem aktuellen Prototyp wird eine zuvor manuell bearbeitete csv-Datei mit den historischen Daten eingelesen, vorverarbeitet, ein GPR-, SVR- und XGBoost-Modell erstellt, diese trainiert, im Anschluss die Prognose der nächsten 4 Quartale durchgeführt und schließlich visualisiert.
